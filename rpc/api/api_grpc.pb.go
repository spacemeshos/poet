...
// All implementations must embed UnimplementedPoetServer
...
// UnimplementedPoetServer must be embedded to have forward compatible implementations.
...
func (UnimplementedPoetServer) mustEmbedUnimplementedPoetServer() {}
